...
public final class ActivityProductListBinding implements ViewBinding {
  ...
  private ActivityProductListBinding(@NonNull CoordinatorLayout rootView,
      @NonNull FloatingActionButton btnAdd, @NonNull FloatingActionButton btnCart,
      @NonNull RecyclerView rvProducts, @NonNull TextView tvSaldo, @NonNull TextView tvTitle) {
  ...
  public static ActivityProductListBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ActivityProductListBinding((CoordinatorLayout) rootView, btnAdd, btnCart,
          rvProducts, tvSaldo, tvTitle);
    }
